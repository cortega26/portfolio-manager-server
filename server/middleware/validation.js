...
const interestRunQuerySchema = z
  .object({
    date: isoDateSchema.optional(),
  })
  .transform((value) => ({ date: value.date ?? null }));

const interestBackfillQuerySchema = z
  .object({
    from: isoDateSchema,
    to: isoDateSchema,
  })
...
export const validateInterestRunQuery = parseWith(
  interestRunQuerySchema,
  'query',
);
export const validateInterestBackfillQuery = parseWith(
  interestBackfillQuerySchema,
  'query',
);
