...
| Software update / release readiness     | Runbooks, playbooks, incidents, and testing strategy that affect day-to-day upgrades. | `docs/operations/incidents/*.md`, `docs/operations/playbooks/*.md`, `docs/operations/runbooks/*.md`, `docs/operations/playbooks/testing-strategy.md`                                          | Update these documents as new procedures emerge. They should always describe the _current_ way we deploy and recover.                                    |
