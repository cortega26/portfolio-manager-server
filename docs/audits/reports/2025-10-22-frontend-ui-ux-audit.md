...
### UI-1 — ROI fallback exposes fabricated benchmark lines _(Resolved 2025-10-21)_
...
### UI-2 — Settings toggles misrepresent inactive features _(Resolved 2025-10-21)_
