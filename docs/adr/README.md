...
| `008-json-table-storage-on-sqljs.md` | Accepted            | The storage layer is `JsonTableStorage` persisted through `sql.js` | `server/data/storage.js`, `server/data/portfolioState.js`, `server/utils/atomicStore.js`                                   |
