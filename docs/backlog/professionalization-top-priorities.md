...
2. **API keys hashed with unsalted SHA-256** _(✅ Resolved 2025-11-04)_ – `digestPortfolioKey` /
...
3. **Client stores raw API keys in `localStorage`** _(✅ Resolved 2025-11-11)_ – The new volatile
...
4. **HTTP logs expose credential headers** _(✅ Resolved 2025-11-11)_ – HTTP logging now applies
...
5. **`server/app.js` is a 50 kB one-liner** _(✅ Resolved 2025-11-12)_ – Common plumbing now lives in
