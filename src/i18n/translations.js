export const translations = {
  en: {
    ...
    'inbox.subtitle': 'Actionable position alerts and milestones, ordered by urgency.',
    'inbox.empty': 'Portfolio is on track. No alerts.',
    'inbox.feed.aria': 'Inbox feed',
    'inbox.item.viewPosition': 'View position',
    'inbox.item.dismiss': 'Dismiss',
    'inbox.item.dismissing': 'Dismissing…',
    'inbox.item.valueLabel': 'Position value',
    'inbox.configure.title': 'Configure thresholds',
    'inbox.seeAll': 'See all →',
    'nav.transactions': 'Transactions',
    'nav.history': 'History',
    'nav.metrics': 'Metrics',
    'nav.realizedGains': 'Realized Gains',
    'nav.reports': 'Reports',
    'nav.settings': 'Settings',
    'nav.admin': 'Admin',
    'nav.compare': 'Compare',
    'compare.title': 'Portfolio Comparison',
    'compare.selectPrompt': 'Select 2 or more portfolios to compare',
    'compare.metrics.cumulativeReturn': 'Cumulative Return',
    'compare.metrics.sharpeRatio': 'Sharpe Ratio',
    'compare.metrics.maxDrawdown': 'Max Drawdown',
    'compare.metrics.currentDrawdown': 'Current Drawdown',
    'compare.portfolioLabel': 'Portfolio',
    'compare.noData': 'No return data for this portfolio',
    ...
    'dashboard.context.sharpeRatio.label': 'Sharpe Ratio',
    'dashboard.context.sharpeRatio.detail': 'Risk-adjusted return (annualized, rf = cash yield)',
    'dashboard.context.currentDrawdown.label': 'Current Drawdown',
    'dashboard.context.currentDrawdown.title':
      'Current decline from the latest NAV peak. A real-time measure of how far you are from all-time highs.',
    'dashboard.context.currentDrawdown.insufficient': 'Insufficient data',
    'dashboard.context.rollingReturns.label': 'Rolling Returns',
    'dashboard.context.rollingReturns.oneMonth': '1M',
    'dashboard.context.rollingReturns.threeMonth': '3M',
    'dashboard.context.rollingReturns.oneYear': '1Y',
    'dashboard.context.rollingReturns.annualized': 'ann.',
    ...
    'dashboard.metrics.dividends': 'Dividend Income',
    'dashboard.metrics.dividends.description': 'YTD {ytd} net ({gross} gross) · TTM {ttm}',
    'dashboard.metrics.dividends.empty': 'No dividend transactions recorded yet.',
    ...
    'dashboard.sectors.title': 'Sector Allocation',
    'dashboard.sectors.empty': 'Add holdings and prices to see the sector breakdown.',
    'dashboard.sectors.aria': 'Portfolio sector allocation donut chart',
    ...
    'transactions.form.amount.remainingCash': 'Remaining cash: {amount}',
    'transactions.form.amount.insufficientCash':
      'Insufficient cash: would exceed balance by {amount}',
    ...
    'transactions.form.price.autoFilled': 'Auto-filled from {source} at {time}',
    'transactions.form.price.autoFillUnavailable': 'Price unavailable — enter manually',
    ...
    'import.dropzone.label': 'Drop your CSV file here or click to browse',
    'import.dropzone.hint': 'CSV files with date, type, ticker, shares, price, amount columns',
    'import.rows': 'rows found',
    'import.parsing': 'Parsing file…',
    'import.validating': 'Validating…',
    'import.importing': 'Importing…',
    'import.done': 'Imported',
    'import.validate': 'Validate (dry run)',
    'import.import': 'Import Data',
    'import.preview.date': 'Date',
    'import.preview.type': 'Type',
    'import.preview.ticker': 'Ticker',
    'import.preview.shares': 'Shares',
    'import.preview.price': 'Price',
    'import.preview.amount': 'Amount',
    'import.preview.more': '+{count} more rows',
    'import.errors.title': 'Import Errors',
    'import.errors.noData': 'CSV file appears to be empty or contains only a header.',
    'import.errors.noMapping':
      'Could not detect required columns (date, type, ticker, shares, price, amount) in the header row.',
    'import.errors.readError': 'Could not read the file.',
    'import.errors.importFailed': 'Import failed. Please check your file and try again.',
    'import.result.success': 'Successfully imported {count} transactions.',
    'import.result.empty': 'No transactions were imported. Check the error details below.',
    'import.result.rowError': 'Row {row}: {message}',
    ...
    'realizedGains.title': 'Realized Gains',
    'realizedGains.subtitle': 'Lot matching method: FIFO · Grouped by calendar year of sale',
    'realizedGains.exportAll': 'Export all CSV',
    'realizedGains.loading': 'Loading realized gains…',
    'realizedGains.empty':
      'No realized gains yet. Closed lots will appear here once you have sell transactions.',
    'realizedGains.disclaimer':
      'For informational purposes only. Not tax advice. Consult a tax professional for your specific jurisdiction.',
    'realizedGains.currentYear': 'Current year',
    'realizedGains.lots': '{count} {count, plural, one {lot} other {lots}}',
    'realizedGains.gains': 'Gains:',
    'realizedGains.losses': 'Losses:',
    'realizedGains.net': 'Net:',
    'realizedGains.yearEmpty': 'No closed lots in {year}.',
    'realizedGains.exportYear': 'Export {year} as CSV',
    'realizedGains.table.ticker': 'Ticker',
    'realizedGains.table.buyDate': 'Buy date',
    'realizedGains.table.sellDate': 'Sell date',
    'realizedGains.table.shares': 'Shares',
    'realizedGains.table.costBasis': 'Cost basis',
    'realizedGains.table.proceeds': 'Proceeds',
    'realizedGains.table.gainLoss': 'Gain / Loss',
    'realizedGains.table.daysHeld': 'Days held',
    'realizedGains.table.term': 'Term',
    'realizedGains.term.long': 'Long-term',
    'realizedGains.term.short': 'Short-term',
    'realizedGains.tradeStats.title': 'Trade Statistics',
    'realizedGains.tradeStats.totalLots': 'Total Lots',
    'realizedGains.tradeStats.winRate': 'Win Rate',
    'realizedGains.tradeStats.profitFactor': 'Profit Factor',
    'realizedGains.tradeStats.avgWin': 'Avg Win',
    'realizedGains.tradeStats.avgLoss': 'Avg Loss',
    'realizedGains.tradeStats.expectancy': 'Expectancy',
    'review.needsAttention': 'Needs Attention',
    'review.needsAttention.empty': 'No action needed — your portfolio is on track.',
    'review.recentChanges': 'Recent Changes',
    'review.recentChanges.empty': 'No meaningful changes since your last review.',
    'review.dataBlockers': 'Data Blockers',
    'review.dataBlockers.empty': 'All data is current.',
    'review.dataBlockers.staleLabel': 'Stale or missing prices:',
    'loadingFallback.text': 'Loading content…',
  },
  es: {
    ...
    'nav.signals': 'Señales',
    'nav.inbox': 'Bandeja',
    'inbox.title': 'Bandeja de acciones',
    'inbox.subtitle': 'Alertas y hitos de posiciones, ordenados por urgencia.',
    'inbox.empty': 'Portafolio al día. Sin alertas.',
    'inbox.feed.aria': 'Bandeja de entrada',
    'inbox.item.viewPosition': 'Ver posición',
    'inbox.item.dismiss': 'Descartar',
    'inbox.item.dismissing': 'Descartando…',
    'inbox.item.valueLabel': 'Valor de posición',
    'inbox.configure.title': 'Configurar umbrales',
    'inbox.seeAll': 'Ver todo →',
    'nav.transactions': 'Transacciones',
    'nav.history': 'Historial',
    'nav.metrics': 'Métricas',
    'nav.realizedGains': 'Ganancias realizadas',
    'nav.reports': 'Reportes',
    'nav.settings': 'Configuración',
    'nav.admin': 'Administración',
    'nav.compare': 'Comparar',
    'compare.title': 'Comparación de Portafolios',
    'compare.selectPrompt': 'Selecciona 2 o más portafolios para comparar',
    'compare.metrics.cumulativeReturn': 'Rendimiento Acumulado',
    'compare.metrics.sharpeRatio': 'Ratio Sharpe',
    'compare.metrics.maxDrawdown': 'Máxima Pérdida',
    'compare.metrics.currentDrawdown': 'Pérdida Actual',
    'compare.portfolioLabel': 'Portafolio',
    'compare.noData': 'Sin datos de rendimiento para este portafolio',
    ...
    'dashboard.zone2.empty': 'Sin alertas ni elementos pendientes. El portafolio está al día.',
    'dashboard.zone2.emptyAria': 'Bandeja de acciones',
    'dashboard.charts.title': 'Gráficas del portafolio',
    ...
    'dashboard.context.sharpeRatio.label': 'Ratio Sharpe',
    'dashboard.context.sharpeRatio.detail':
      'Retorno ajustado por riesgo (anualizado, sr = rendimiento caja)',
    'dashboard.context.currentDrawdown.label': 'Drawdown actual',
    'dashboard.context.currentDrawdown.title':
      'Caída actual desde el último pico de NAV. Una medida en tiempo real de cuán lejos estás de los máximos históricos.',
    'dashboard.context.currentDrawdown.insufficient': 'Datos insuficientes',
    'dashboard.context.rollingReturns.label': 'Rendimientos móviles',
    'dashboard.context.rollingReturns.oneMonth': '1M',
    'dashboard.context.rollingReturns.threeMonth': '3M',
    'dashboard.context.rollingReturns.oneYear': '1A',
    'dashboard.context.rollingReturns.annualized': 'anual.',
    ...
    'dashboard.metrics.dividends': 'Ingreso por dividendos',
    'dashboard.metrics.dividends.description': 'YTD {ytd} neto ({gross} bruto) · 12M {ttm}',
    'dashboard.metrics.dividends.empty': 'Aún no hay transacciones de dividendos registradas.',
    ...
    'dashboard.sectors.title': 'Asignación sectorial',
    'dashboard.sectors.empty': 'Agrega posiciones y precios para ver el desglose sectorial.',
    'dashboard.sectors.aria': 'Gráfico de dona de asignación sectorial del portafolio',
    ...
    'transactions.form.amount.remainingCash': 'Efectivo restante: {amount}',
    'transactions.form.amount.insufficientCash':
      'Efectivo insuficiente: excede el saldo en {amount}',
    ...
    'transactions.form.price.autoFilled': 'Completado desde {source} a las {time}',
    'transactions.form.price.autoFillUnavailable': 'Precio no disponible — ingrese manualmente',
    ...
    'prices.status.stale': 'Desactualizado',
    'prices.status.error': 'Error',
    ...
    'import.title': 'Importar datos CSV',
    'import.dropzone.label': 'Suelta tu archivo CSV aquí o haz clic para buscar',
    'import.dropzone.hint': 'Archivos CSV con columnas: date, type, ticker, shares, price, amount',
    'import.rows': 'filas encontradas',
    'import.parsing': 'Analizando archivo…',
    'import.validating': 'Validando…',
    'import.importing': 'Importando…',
    'import.done': 'Importado',
    'import.validate': 'Validar (prueba en seco)',
    'import.import': 'Importar datos',
    'import.preview.date': 'Fecha',
    'import.preview.type': 'Tipo',
    'import.preview.ticker': 'Ticker',
    'import.preview.shares': 'Acciones',
    'import.preview.price': 'Precio',
    'import.preview.amount': 'Monto',
    'import.preview.more': '+{count} filas más',
    'import.errors.title': 'Errores de importación',
    'import.errors.noData': 'El archivo CSV parece estar vacío o solo contiene un encabezado.',
    'import.errors.noMapping':
      'No se pudieron detectar las columnas requeridas (date, type, ticker, shares, price, amount).',
    'import.errors.readError': 'No se pudo leer el archivo.',
    'import.errors.importFailed': 'Error al importar. Revisa tu archivo e inténtalo de nuevo.',
    'import.result.success': 'Se importaron {count} transacciones correctamente.',
    'import.result.empty': 'No se importaron transacciones. Revisa los detalles del error.',
    'import.result.rowError': 'Fila {row}: {message}',
    ...
    'realizedGains.title': 'Ganancias realizadas',
    'realizedGains.subtitle': 'Método de coincidencia: FIFO · Agrupado por año calendario de venta',
    'realizedGains.exportAll': 'Exportar todo CSV',
    'realizedGains.loading': 'Cargando ganancias realizadas…',
    'realizedGains.empty':
      'Aún no hay ganancias realizadas. Los lotes cerrados aparecerán aquí cuando tengas transacciones de venta.',
    'realizedGains.disclaimer':
      'Solo para fines informativos. No es asesoramiento fiscal. Consulta a un profesional de impuestos para tu jurisdicción específica.',
    'realizedGains.currentYear': 'Año actual',
    'realizedGains.lots': '{count} {count, plural, one {lote} other {lotes}}',
    'realizedGains.gains': 'Ganancias:',
    'realizedGains.losses': 'Pérdidas:',
    'realizedGains.net': 'Neto:',
    'realizedGains.yearEmpty': 'No hay lotes cerrados en {year}.',
    'realizedGains.exportYear': 'Exportar {year} como CSV',
    'realizedGains.table.ticker': 'Ticker',
    'realizedGains.table.buyDate': 'Fecha compra',
    'realizedGains.table.sellDate': 'Fecha venta',
    'realizedGains.table.shares': 'Acciones',
    'realizedGains.table.costBasis': 'Base coste',
    'realizedGains.table.proceeds': 'Ingresos',
    'realizedGains.table.gainLoss': 'Ganancia / Pérdida',
    'realizedGains.table.daysHeld': 'Días retenido',
    'realizedGains.table.term': 'Plazo',
    'realizedGains.term.long': 'Largo plazo',
    'realizedGains.term.short': 'Corto plazo',
    'realizedGains.tradeStats.title': 'Estadísticas de trading',
    'realizedGains.tradeStats.totalLots': 'Total de lotes',
    'realizedGains.tradeStats.winRate': 'Tasa de acierto',
    'realizedGains.tradeStats.profitFactor': 'Factor de ganancia',
    'realizedGains.tradeStats.avgWin': 'Ganancia media',
    'realizedGains.tradeStats.avgLoss': 'Pérdida media',
    'realizedGains.tradeStats.expectancy': 'Expectativa',
    'review.needsAttention': 'Requiere atención',
    'review.needsAttention.empty': 'No se requiere acción — tu portafolio va por buen camino.',
    'review.recentChanges': 'Cambios recientes',
    'review.recentChanges.empty': 'No hay cambios significativos desde tu última revisión.',
    'review.dataBlockers': 'Bloqueos de datos',
    'review.dataBlockers.empty': 'Todos los datos están actualizados.',
    'review.dataBlockers.staleLabel': 'Precios desactualizados o faltantes:',
    'loadingFallback.text': 'Cargando contenido…',
  },
};
